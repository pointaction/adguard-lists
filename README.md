...
| `pasblock-completeblocklist.txt` | — | 961,878 |
...
| `pasfalse-positive-fixes.txt` | 95 | — |
| `paswhitelist.txt` | 83 | — |
| **Total (sum)** | **9,778** | **2,407,876** |
| **Total (unique domains)** | **8,193** | **1,117,511** |
